...
export default function ActivityCard ({
  ...
  return <>
    <div className="w-full h-full flex items-center justify-center bg-slate-900">
      <div className="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700 absolute">
        <div className="h-full w-full absolute opacity-30 left-0 top-0 z-0" style={{backgroundImage:`linear-gradient(to top left, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 1) 50%), url(${activity.image})`}}></div>
        <h5 className="mb-4 text-xl font-medium text-black dark:text-white relative"> {activity.activity} </h5>
        ...
        <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-200 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center relative">
          Save
        </button>
